...
@optional
///
- (void)clickWithCellTitle:(NSString *_Nonnull)tit indexPathRow:(NSInteger)index;
/// 视图已经出现
...
typedef void(^ClickTitle)(NSString * _Nonnull str,NSInteger index);
...
@property (nonatomic, copy) ClickTitle clickCompletion;
